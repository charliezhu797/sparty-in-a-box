...
private:
    ...
    std::shared_ptr<MachineDrawable> mMachineDrawableLeft;

    /// The machine drawable on the right
    std::shared_ptr<MachineDrawable> mMachineDrawableRight;
...
public:
    ...
    */
    ...
    std::shared_ptr<MachineDrawable> GetMachineDrawable(bool left);

    void SetMachineDrawable(std::shared_ptr<MachineDrawable> machineDrawable, bool left);

    MachineStartTimeDlg CreateDlg(wxWindow *parent);
