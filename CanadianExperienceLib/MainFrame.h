...
public:
    ...
    void Initialize();
    void OnEditChooseMachineLeft(wxCommandEvent &event);
    void OnEditChooseMachineRight(wxCommandEvent &event);
    void OnEditSetMachineStartTime(wxCommandEvent &event);
};
